 ...
 */
async function generateSprite(icons: Map<string, string>, config: Required<SpriteConfig>): Promise<string> {
...
export function getSpriteUrl(iconName: SpriteIconName): string {
  return \`/sprites/${SPRITE_FILE}#lucide-\${iconName}\`
}
`
}
