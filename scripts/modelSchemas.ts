import { z } from 'zod'
import ModelsData from '../notes/or-samples/frontend/models.json'
...
export const ModelSchema = z
  .object({
    ...
    endpoint: z.record(z.unknown()).nullable(), // NOTE: EndpointSchemaInternal object
  })
  .strict()

// Perform parsing
try {
  ModelSchema.array().parse(ModelsData.data)
  console.log('Model schemas parsed successfully!')
} catch (e) {
  console.error('Error parsing model schemas:', e)
  process.exit(1)
}
