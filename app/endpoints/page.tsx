...
export const metadata: Metadata = {
  title: 'Endpoints',
  description: 'Compare the models and providers available on OpenRouter',
}
  ...
  return (
    <PageContainer className="overflow-hidden px-0 pb-0 sm:px-0 sm:pb-0">
      <PageHeader>
        ...
        <PageDescription>Compare the models and providers available on OpenRouter</PageDescription>
      </PageHeader>
